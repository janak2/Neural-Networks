...
class ArtistConvNet:
  ...
  def build_graph(self):
    with self.graph.as_default():
      ...
      if POOL1:
        conv1 = tf.layers.max_pooling2d(inputs=conv1, pool_size=6, strides=1)
      if BN: 
      ...
      if POOL2:  
        conv2 = tf.layers.max_pooling2d(inputs=conv2, pool_size=6, strides=1)
      if BN:
